function doGet() {
  ...
  const departments = [
    ...
    { cat: "ECONOMIC DEVELOPMENT", name: "City Agriculture Office", acronym: "CAGO", head: "Esmenia S. Lulu", loc: "Ground Floor - Left", time: "8:00 AM - 5:00 PM", services: ["Seed Distribution", "Farming Consultations"] },
    { cat: "ECONOMIC DEVELOPMENT", name: "City Veterinary Office", acronym: "CVO", head: "Dr. Celso D. Mananggit", loc: "Ground Floor - Left", time: "8:00 AM - 5:00 PM", services: ["Anti-Rabies Vaccination", "Livestock Health Services"] },
    ...
    { cat: "FISCAL MANAGEMENT", name: "City Accounting Office", acronym: "CACO", head: "Christina R. Yambot", loc: "Ground Floor - Right", time: "8:00 AM - 5:00 PM", services: ["Internal Audit", "Financial Reporting"] },
